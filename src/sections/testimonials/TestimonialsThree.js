        ...
        <TestimonialContainer>
          <Container>
            ...
            <AnimationContainer animation="fadeIn">
              <TestimonialsThreePart
                testimonials={this.props.testimonials}
                quotation_up={this.props.quotation_up}
                quotation_down={this.props.quotation_down}
              />
            </AnimationContainer>
          </Container>
        </TestimonialContainer>
...
export default (props) => (
  <StaticQuery
    ...
    `}
    render={({ quotation_up, quotation_down, testimonials }) => (
      <TestimonialsThree
        quotation_up={quotation_up}
        quotation_down={quotation_down}
